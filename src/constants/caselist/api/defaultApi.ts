...
export class DefaultApi {
     ...
     */
    public async getSchool_1 (caselist: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Caselist;  }> {
        ...
        // verify required parameter 'caselist' is not null or undefined
        if (caselist === null || caselist === undefined) {
            throw new Error('Required parameter caselist was null or undefined when calling getSchool_1.');
        }
